...
setwd("G:/Shared drive/snvdem/snvdem24")
```
...
library(sf)
col <- st_read("G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/BaseLayer/MGN_ANM_MPIOS.shp")
col <- col %>%
  select(1:8)
...
library(readxl)
MGN18 <- read_excel("G:/Shared drive/snvdem/snvdem24/data/geospatial/MGN_ANM_MPIOS/MGN18.xls") 
...
IR18 <- read_excel("G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/0-1_Rurality/PANEL_CARACTERISTICAS_GENERALES(2021).xlsx")
...
write.csv(IR18, file = "G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/0-1_Rurality/IR18_0-1.csv", row.names = FALSE)
...
VAM18 <- read_excel("G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/2-3_EconDevt/anexo-2020-2021-provisional-valor-agregado-municipio-2011-2021.xlsx", sheet = "Cuadro 9", range = "A11:I1133")
...
PBID <- read_excel("G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/2-3_EconDevt/anex-PIBDep-RetropolacionDepartamento-2022pr.xlsx", sheet = "Cuadro 1", range = "A10:AS36")
PBID <- PBID %>%
...
write.csv(ED18_2t3, file = "G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/2-3_EconDevt/ED18_2-3.csv", row.names = FALSE)
...
# municipal-level data for distance to capital city
CEDE18 <- read_excel("G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/4-5_DisCapital/PANEL_CARACTERISTICAS_GENERALES(2021).xlsx")
...
# For ArcMaps, export the final merge to a .csv file
write.csv(CEDE18, file = "G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/4-5_DisCapital/DC18_4-5.csv", row.names = FALSE)
...
reg <- read_csv("G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/6-9_Cardinal/Departamentos_y_municipios_de_Colombia_20240312.csv")
reg <- reg %>%
...
write.csv(reg, file = "G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/6-9_Cardinal/CD18_6-9.csv", row.names = FALSE)
...
write.csv(RP18_15t16, file = "G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/15-16_RulingParty/RP18_15-16.csv", row.names = FALSE)
...
st_write(col, "G:/Shared drive/snvdem/snvdem24/data/geospatial/2018pmq/MGN_2018r.shp")
